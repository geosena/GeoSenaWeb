<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListadoSedes.aspx.cs" Inherits="GeoSenaWeb.Informes.ListadoSedes" %>
<%@ Register Assembly="CrystalDecisions.Web, Version=13.0.2000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div class="panel panel-info">
            <div class="panel-heading">
                <h2 class="panel-title">Listado Sedes de Formacion</h2>
                <br />
            ...
            <div class="panel-body center-block">
               <CR:CrystalReportViewer ID="ListadoSedesFormacion" runat="server" AutoDataBind="true"
